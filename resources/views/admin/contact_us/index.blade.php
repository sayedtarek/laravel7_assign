@extends('admin.layouts.index_layout' , ['title' => 'contact_us' ,'route' => 'complaints'])
                    ...
                    <div class="m-section__content">
                        ...
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                                    <th><b>العنوان</b></th>
                                    <th><b>البريد الإلكترونى</b></th>
                                    <th><b>التاريخ والوقت</b></th>
                                    <th><b>التحكم</b></th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <th scope="row">{{ $complaint->email }}</th>
